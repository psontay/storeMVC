...
public class SupplierServiceImpl implements SupplierService {
  ...
  public SupplierResponse createSupplier(SupplierCreationRequest supplierCreationRequest) {
    ...
    Supplier supplier =
        Supplier.builder()
            .name(supplierCreationRequest.getName())
            .fullName(supplierCreationRequest.getFullName())
            .email(supplierCreationRequest.getEmail())
            .telPhone(supplierCreationRequest.getTelPhone())
            .build();
