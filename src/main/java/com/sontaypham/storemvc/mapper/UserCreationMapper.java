...
@Mapper(
    ...
    uses = {RoleMapperHelper.class, PermissionMapperHelper.class})
public interface UserCreationMapper {
  ...
  // role mapper helper
  @Named("toRoleObject")
  static Set<Role> toRoleObject(
      Set<String> roleString, @Context RoleMapperHelper roleMapperHelper) {
    return roleMapperHelper.toRoleObject(roleString);
  }

  @Named("toRoleString")
  static Set<String> toRoleString(
      Set<Role> roleObject, @Context RoleMapperHelper roleMapperHelper) {
